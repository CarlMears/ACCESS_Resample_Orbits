module equirectangular_maps
    ...
    type map_str
        ...
        real(real32),dimension(:,:),allocatable :: dat             ! map data
...
contains
    ...
    subroutine downsample_map(oldmap,num_x,type_x,num_y,type_y,newmap,error)
        ...
        real(real32),dimension(:,:),pointer    ::  map_sum
        real(real32),dimension(:,:),pointer    ::    map_sum_wts
...
333                            format(1x,2f9.2,i4,i4,2f9.2)
    ...
    subroutine write_map_netcdf(mp,nc_filename,error,title)
        ...
        call handle_nc_err(nf90_def_var(ncid, "Data", NF90_FLOAT, [dim_lon,dim_lat], varid, &
    ...
    end subroutine write_map_netcdf

    ! subroutine write_map_netcdf(mp,nc_filename,error,cf_var_metadata,cf_global_metadata)
    ! !subroutine write_map_netcdf(mp,nc_filename,error,title)
    !     use io_nc, only: handle_nc_err, minmax_iso8601
    !     use netcdf
    !     use CF_metadata, only: CF_1_8_attr,init_CF_1_8_attr,put_CF_1_8_attr
...
end module equirectangular_maps
