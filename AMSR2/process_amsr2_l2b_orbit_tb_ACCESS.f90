 ...
 program process_amsr2_l2b_orbit_tb_ACCESS   
    ...
    print *,use_rectangular_grid
    print *,use_NP_grid
    print *,use_SP_grid
    print *,footprint_size
    print *, iorbit_start
    print *, iorbit_end
    print *,channel_list
 ...
 subroutine process_and_resample_amsr2_l2b_orbit(iorbit,  &                  ! orbit to process
    ...
    use sat_id_module, only: band_number
    use l2_module        
    ...
    use l2_module_extra
    use l2_module_extra, only: initialize_l2_extra_arrays,cleanup_l2_extra_arrays
    use resample, only: init_resample_weights,ResampleWeights,free_resample_weights
    use resample, only: resample_ta_extra ,resample_89_ta_extra
    ...
    call initialize_l2_extra_arrays
    ...
    if (write_swath_tbs) then
        ...
        call write_tb_native_netcdf(trim(filename_l2b_tb_nc),iorbit,1)
    endif
    ...
    do ifreq = 1,amsr2_nfreq
        ...
        if (ifreq .le. 6) then
            ...
            print *,'Resampling Channel: ',13
            call resample_89_ta_extra(amsr2_wts,13)  ! Vpol
            print *,'Resampling Channel: ',14
            call resample_89_ta_extra(amsr2_wts,14)      ! Hpol
        endif
    ...
    if (write_swath_geoloc) then
        ...
        call write_geoloc_extra_netcdf(trim(filename_l2b_tb_resamp),iorbit,1)
    endif
    ...
    if ((use_rectangular_grid) .and. any(do_freq_rect)) then
        ...
        print *,'All rect grid files exist - skipping orbit ',iorbit
    ...
    if ((use_NP_grid) .and. any(do_freq_polar)) then
        ...
        print *,'All polar grid files exist - skipping orbit ',iorbit
    endif
